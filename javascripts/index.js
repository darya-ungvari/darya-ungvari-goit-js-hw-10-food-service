...
const source = document.querySelector('#product-item-js').innerHTML.trim();  
...
//   imageItem.setAttribute('src', element.preview);
//   imageItem.setAttribute('alt', element.description);
//   imageItem.setAttribute('data-source', element.original);
//   imageItem.classList.add('gallery__image');
//   imageItem.classList.add('gallery__link');
//   galleryItem.appendChild(imageItem);  
//   galleryList.appendChild(galleryItem);

//   imageItem.addEventListener('click', openFullScreenImage);
...
function changeTheme(e) {
    console.log('this is change theme function');
    console.log(this.checked);
    const addClassOnBody = document.getElementsByTagName('body')[0];
    if (this.checked) {
        addClassOnBody.classList.add('dark-theme');
    } else {
        addClassOnBody.classList.remove('dark-theme')
